...
class About extends React.Component {
 ...
 intern at JHU APL Air Missile Defense as a Software Engineering Intern helping expand their React/Redux/Saga/Jest/Flask codebase- a mission planner for the Department of Defense to be used by Navy Warfighters.
		...
		<h6>A picture with some influential people in the video game industry<br/>(left) Emil Pagliarulo, Lead Designer and Writer for Fallout 3 at Bethesda (right) Ed Fries, Former Vice President of publishing at Microsoft</h6>
		 <img
          alt="loading"
          className="desc"
          src={mhsHackathon}
